...
@SpringBootTest
public class BeeroOrderControllerTest extends BaseIT {
    ...
    void setUp() {
        ...
        stPeteCustomer = customerRepository.findAllByCustomerName(DefaultBreweryLoader.DUNEDIN_DISTRIBUTING).orElseThrow();
        stPeteCustomer = customerRepository.findAllByCustomerName(DefaultBreweryLoader.KEY_WEST_DISTRIBUTORS).orElseThrow();
